...
SECRET_KEY = 'django-insecure-&2$wnud3dd3*ziw1(jh4^850a+-=g+ma#091pokyyh*6%w!ahq'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'dynamic')],   #template foolder directory defining and os to be imported
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
